clause=/home/zhangliao/ilp_out_coq/ilp_out_coq/data/json/rules/prop/32442.pl
...
tac=simpl
python stats/stat_tac_filter.py --clause $clause --pred $pred --test $test --label $label --all_predc $all_predc --tac simpl